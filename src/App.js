...
const App = () => {
  ...
  useEffect(() => {
    ...
    const currentCop = useParalelo ? rates.cop * 0.90 : rates.cop;
  ...
  const convert = useCallback((field, value) => {
    ...
    // Aplicamos un factor de castigo común (aprox 10% menos de valor del peso frente al bolívar)
    const currentCopRate = useParalelo ? rates.cop * 0.90 : rates.cop;
